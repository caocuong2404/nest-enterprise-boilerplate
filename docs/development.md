...
> Note: NestJS Enterprise Boilerplate uses [TypeORM](https://github.com/typeorm/typeorm) with Data Mapper pattern.
...
##### Docker Compose
After completing the steps above, you can use [this docker-compose file](../docker-compose_mysql.yml) for nest-enterprise-boilerplate with MySQL (instead of PostgreSQL).
